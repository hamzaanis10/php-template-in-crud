...
<html lang="en">
  ...
  include('connection.php');
    ...
    $select_query = "select * from creat_post where id = $id";
    ...
    <div class="container py-md-5 container--narrow">
      <form action="#" method="POST">
        <div class="form-group">
          ...
          <input required name="title" id="post-title" value="<?php echo $title; ?>" class="form-control form-control-lg form-control-title" type="text" placeholder="" autocomplete="off" />
        </div>

        <div class="form-group">
          <label for="post-body" class="text-muted mb-1"><small>Body Content</small></label>
          <textarea required name="body"  id="post-body"  class="body-content tall-textarea form-control" type="text"><?php echo $body; ?></textarea>
        </div>
...
<?php
  if(isset($_POST['submit'])){
    ...
    $update_query = "update creat_post set title = '$title', 
      body_content = '$body' where id = $id";
