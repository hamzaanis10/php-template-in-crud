  ...
  <body>
    ...
    <?php
      ...
      <div class='d-flex justify-content-between'>
        <h2>$title</h2>
        <span class='pt-2'>
          <a href='edit-post.php?post_id=$id' class='text-primary mr-2' data-toggle='tooltip data-placement='top' title='Edit'><i class='fas fa-edit'></i></a>
          <a href='post-delete.php?post_id=$id' class='text-danger mr-2' data-toggle='tooltip data-placement='top' title='Delete'><i class='fas fa-trash'></i></a>
        </span>
      </div>
      
      <p class='text-muted small mb-4'>
        <a href='#'><img class='avatar-tiny' src='https://gravatar.com/avatar/f64fc44c03a8a7eb1d52502950879659?s=128' /></a>
        Posted by <a href='#'>kittydoe</a> on $date
      </p>
