...
<html lang="en">
  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        <div class="flex-row my-3 my-md-0">
          ...
          <a class="btn btn-sm btn-success mr-2" href="create-post.php">Create Post</a>
    ...
    <div class="container py-md-5 container--narrow">
      ...
      <?php
        $select_query = "select * from creat_post";
      ...
      <div class="profile-nav nav nav-tabs pt-2 mb-4">
        <a href="#" class="profile-nav-link nav-item nav-link active">Posts: <?php echo $count; ?></a>
         ...
         while($row = mysqli_fetch_assoc($result)){
          ...
          echo "
            <div class='list-group'>
              <a href='/php crud/post.php?post_id=$id' class='list-group-item list-group-item-action'>
              <img class='avatar-tiny' src='https://gravatar.com/avatar/b9408a09298632b5151200f3449434ef?s=128' />
              <strong>$title</strong> on $date
              </a>
            </div>
          ";
         }
